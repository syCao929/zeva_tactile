...
_CF_TYPE_ALIASES = {
    ...
    "cosmos_framework.configs.base.defaults.model_config.FixedStepSamplerConfig": "fixed_step_sampler_config",
    "cosmos_framework.configs.base.defaults.model_config.LBLConfig": "lbl_config",
    "cosmos_framework.configs.base.defaults.model_config.OmniMoTModelConfig": "omni_mot_model_config",
    "cosmos_framework.configs.base.defaults.model_config.RectifiedFlowInferenceConfig": "rectified_flow_inference_config",
    "cosmos_framework.configs.base.defaults.model_config.RectifiedFlowTrainingConfig": "rectified_flow_training_config",
    "cosmos_framework.configs.base.defaults.activation_checkpointing.ActivationCheckpointingConfig": "activation_checkpointing_config",
    "cosmos_framework.configs.base.defaults.compile.CompileConfig": "compile_config",
    "cosmos_framework.configs.base.defaults.ema.EMAConfig": "ema_config",
    "cosmos_framework.configs.base.defaults.parallelism.ParallelismConfig": "parallelism_config",
    "cosmos_framework.configs.base.defaults.quantization.QuantizationConfig": "quantization_config",
    "cosmos_framework.configs.base.defaults.vlm.PretrainedWeightsConfig": "pretrained_weights_config",
    "cosmos_framework.configs.base.defaults.vlm.VLMConfig": "vlm_config",
    "cosmos_framework.model.generator.tokenizers.wan2pt2_vae_4x16x16.Wan2pt2VAEInterface": "wan2pt2_vae_interface",
    "cosmos_framework.model.generator.mot.unified_mot.Qwen3VLMoTConfig.from_json_file": "qwen3_vl_mot_config_from_json_file",
    "cosmos_framework.model.generator.mot.unified_mot.Qwen3VLTextForCausalLM": "qwen3_vl_text_for_causal_lm",
    "cosmos_framework.model.generator.omni_mot_model.OmniMoTModel": "omni_mot_model",
    "cosmos_framework.configs.base.defaults.reasoner.create_qwen2_tokenizer_with_download": "create_qwen2_tokenizer_with_download",
    "cosmos_framework.configs.base.defaults.reasoner.create_vlm_config": "create_vlm_config",
}
...
_TARGET_ALIASES.update(_CF_TYPE_ALIASES)
_TYPE_ALIASES.update(_CF_TYPE_ALIASES)
